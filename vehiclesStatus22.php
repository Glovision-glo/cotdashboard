...
#allreports{position: absolute; background-color: transparent; top:18.5%;left:0px;width:20%;height:80%; z-index: 99; background: #e5e7e9;opacity:1;border-style: solid;
    border-color: black; }
	rc="images1/towardsscene.png" height="32" width="16"> </td><td> Vehicle is running and case assigned</td>
              <td> <img src="images1/atscene.png" height="32" width="16"> </td><td> Vehicle is running and at scene</td>
              <td> <img src="images1/towardshospital.png" height="32" width="16"> </td><td> Vehicle is running and ready to take case</td>
              <td> <img src="images1/online.png" height="32" width="16"> </td><td> Vehicle is idle and case assigned</td>
              <td> <img src="images1/idle.png" height="32" width="16"> </td><td> Vehicle is idle and at scene</td>
              <td> <img src="images1/offline-caseassigned.png" height="32" width="16"> </td><td> Vehicle is offline and case assigned</td>
              <td> <img src="images1/offline-casenotassigned.png" height="32" width="16"> </td><td> Vehicle is offline and at scene</td>
       ...
       <table align="center"  background="#086A87" style="border-bottom:1pt solid black;">  
        <tr>
          ...
          <!--  <th> 
           ...
           <th align="right"><input type="button" id="selectingGroupID" value="All ">&nbsp&nbsp <input type="button" id="online" value="(0)" /><img src="images/on.gif"> 
...
<div id="menu">
    ...
    <ul class="menu">
        ...
        <li><a onclick="window.open('info.html')"><span>Info</span></a></li>
           <li><a onclick="$('#legend').slideToggle('slow');"><span>Show/Hide</span></a></li>
  ...
  <!--      <div align="center">Powered by <a class="changeBlue" href=""  onclick="window.open('http://www.glovision.co')">Glovision</a></div>
      ...
      <div id='legend'>
        <table border="1" cellpadding="0" cellspacing="0">
              ...
              <td> <img src="images1/towardsscene.png" height="32" width="16"> </td><td> Vehicle is running and towards scene</td>
              <td> <img src="images1/atscene.png" height="32" width="16"> </td><td> Vehicle is running and at scene</td>
              <td> <img src="images1/towardshospital.png" height="32" width="16"> </td><td> Vehicle is running and towards hospital</td>
              <td> <img src="images1/online.png" height="32" width="16"> </td><td> Vehicle is running and Ready to take case</td>
              <td> <img src="images1/idle.png" height="32" width="16"> </td><td> Vehicle is idle and Ready to take case</td>
              <td> <img src="images1/offline-caseassigned.png" height="32" width="16"> </td><td> Vehicle is offline and case assigned</td>
              <td> <img src="images1/offline-casenotassigned.png" height="32" width="16"> </td><td> Vehicle is offline and case not assigned</td>
      </tr>        
