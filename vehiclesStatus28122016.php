...
/*	  document.getElementById('allreports').style.display="block";
  ...
  */    var formate ="html";//document.getElementById("reportFormate").value;
    ...
    //  window.open("../rjdistanceidlereport/distanceidlereport.php?&accountID="+ac+"&userID="+uid+"&currentLocation=currentlocation&formate="+formate+"&selectedgroup="+groupdevice) 
       ...
       if(id.value=="Report 2014"){ url="php/102casemangerReport2014.php";}
         if(id.value=="Report 2016"){ url="php/102casemangerReport2016.php";}
          $.ajax({
             type : 'get',
                  url:url,
 ...
 function getHighways(id){
	...
	function inmotion(buttontype){
	       ...
	       var ac=window.localStorage.getItem('accountID');
	       var uid=window.localStorage.getItem('userId');
	       var buttons=["casereport","highway","nocasesreport","pdfreport","stoppage","offlinereport","powercutlog","overspeed","currentstatusreport","inmotion","daywisestatus","historytracking","livevehicletracking","eventlog","rawdata","distanceidle","casemanagerreport"];
	       for(var x=0;x<buttons.length;x++){
               ...
               document.getElementById("casereport2016").style.display="none";
              ...
              if(buttontype=="stoppage"){
               ...
               }else if(buttontype=="casereport"){
                       document.getElementById("reportheading").innerHTML="Case Report";
                }
              ...
              document.getElementById("ignitionID").style.display="block";
                   ...
                   if(buttontype=="pdfreport" || buttontype=="nocasesreport"){
                    ...
                    if(buttontype=="highway"){
                      ...
                      if(buttontype=="casereport"){
                        document.getElementById("casereport2016").style.display="block";
                       // document.getElementById("vehiclesIDs").style.display="none";
                       // document.getElementById("selectedgroupID").style.display="none";
                   }
            ...
            <div><ul>
              ...
              <!--      <li><a onclick="inmotion('offlinereport')"><span>Offline</span></a></li>
                  ...
                  <li id="nocases"><a onclick="inmotion('nocasesreport')"><span>No Cases Report</span></a></li>
                   ...
                   <li id="case"><a onclick="inmotion('casereport')"><span>Case Report</span></a></li>
...
<option value="daywisestatusreport">Day wise all Vehicle Report </option>
         ...
         <tr>
               <td align="center" colspan='2'> <input type="button" id="pdfreport" class='textcss1' value="Get Report" style="width: 100px;" onclick="getPDFFile(this);"/></td>
           </tr>
 
   <tr>
               <td align="center" colspan='2'> <input type="button" id="nocasesreport" class='textcss1' value="No Cases Data" style="width: 100px;" onclick="getOverSpeedReport1(this);"/></td>
           </tr>
      <tr>
               <td align="center" colspan='2'> <input type="button" id="dynamicdistanceidlereport" class='textcss1' value="Predefined Report" style="width: 100px;" onclick="distanceIdlereport(this);"/></td>
           </tr>
       <tr>
...
<tr>
               <td align="center" colspan='2'> <input type="button" id="casereport" class='textcss1' value="Report 2014" style="width: 100px;" onclick="distanceIdlereport(this);"/></td>
           </tr>
<tr>
               <td align="center" colspan='2'> <input type="button" id="casereport2016" class='textcss1' value="Report 2016" style="width: 100px;" onclick="distanceIdlereport(this);"/></td>
           </tr>
