...
initialise4();
 ...
 function initialise4(){
    if(map==null) {
       map = new MapmyIndia.Map('mapcontainer', {center: [21.0000, 78.0000], zoomControl: true, hybrid: true});
    map.invalidateSize();
  }
        ...
        for(var i=0;i<vehicleWithEventData.length;i++){
            ...
            if(vehicleWithEventData[i].length>0){
                ...
                if(mapInitializeOnce==0){
                       ...
                       map = new MapmyIndia.Map('mapcontainer', {center: [parseFloat(vehicleWithEventData[i][0][6]),parseFloat(vehicleWithEventData[i][0][7])], zoomControl: true, hybrid: true});
                      map.invalidateSize();
