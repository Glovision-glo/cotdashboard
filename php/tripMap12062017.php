          ...
          path: google.maps.SymbolPath.FORWARD_CLOSED_ARROW
            ...
            var timeintaveldiff=0;
             for(var m=0;m<event.length-1;m++){
                  ...
                  if(statusdis=="Moving" || statusdis=="Idle"){
           ...
           var info="Asset :"+vehicleID+"  &nbsp"+name+"<br>Starting Locaton :"+factory+"<br>Travell Distance:"+parseInt(cumulativeDistance)+" Km";
              pushpin(map,slat,slong,info,"yes",100);

                         document.getElementById('info').innerHTML="<table class='tablecss'><tr><td>Vehicle ID :</td><td> "+vehicleID.toUpperCase()+"</td></tr><tr><td>Distance : </td><td>"+parseInt(cumulativeDistance)+" Km</td></tr><tr><td>S lat/lng :</td><td>"+slat+"/"+slong+"</td></tr><tr><td>E lat/lng:</td><td>"+elat+"/"+elong+"</td></tr></table>";
...
function reload(){
 ...
 function showrawhistory(){
   ...
   <style>
         ...
         #mapcontainer { height: 100%; width:100% ;left:0%;border:solid} 
         #rawdata{ height: 100%; width:100%;}
         #wrapper { position: relative; } 
         #logout {border-radius: 0px; position: absolute; background-color: transparent;height:100%; width:20%;top:64px; left:0px; z-index: 99; background: #d6dbdf;} 
         #help{ 
         ...
         #info {border-radius: 0px; position: absolute; background-color: transparent;height:63px; width:20%;top:0px; left:0px; z-index: 99; background: #d6dbdf;;}
