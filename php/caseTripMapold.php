...
function getCaseInfo($caseID){
      ...
      $Query="select * From caseFlow where caseID='$caseID'";
      $rs =mysqli_query($tacconnect,$Query) or die ("Query error1: " . mysqli_error($tacconnect));
      while($row = mysqli_fetch_assoc($rs)) {
          $result[0]=$row['ambyAssignedTime'];
          $result[1]=$row['ambyDepartTime'];
          $result[2]=$row['pickUpPointArriveTime'];
          $result[3]=$row['pickUpPointDepartTime'];
          $result[4]=$row['destinationArriveTime'];  
          $result[5]=$row['destinationDepartTime'];
          $result[6]=$row['backToBaseDepartTime'];
          $result[7]=$row['destinationHospital'];
          $result[8]=$row['deviceID'];
          $result[9]=$row['beneficiaryName'];
          $result[10]=$row['beneficiaryContact'];
          $result[11]=$row['hospitalDistrict'];
          $result[12]=$row['hospitalName'];
      }
