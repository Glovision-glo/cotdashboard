...
$caseDist=0;
 ...
 $newpdf->pdfcreation($table,$accountID.'_'.$group.'_'.$fromDate.'_casemanagerreport',null,"Case Manager Report",date('d-m-Y',$fromDate));

  $excel=new ExcelService();
$excel->generateExcel($table,$accountID.'_'.$group.'_'.$fromDate.'_casemanagerreport');

echo $table;

// $newpdf=new PdfGeneretor();
// $newpdf->pdfcreation($table,$accountID.'_'.$group.'_'.$fromDate.'_casemanagerreport',null,"Case Manager Report"," Monthly Report");
