...
//  $accountID=$_GET['accountID'];
   $image=$accountID.'.png';
    ...
    // create curl resource
        ...
        // set url
        curl_setopt($ch, CURLOPT_URL, "http://glotrax.glovision.co/gjdashboard/php/vehiclesStatus.php?&accountID=$accountID&userID=admin&currentLocation=currentlocation&formate=html&selectedgroup=selectall");
    //  echo 'rama';
