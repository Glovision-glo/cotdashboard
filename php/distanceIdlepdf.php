...
//error_log($reportFormate.'Rep For');
    ...
    if (isset($_GET['fromDate'])) {
       ...
       $croneRequest="no";
       $toDayDate=strtotime(date('d-M-Y',strtotime("-7 days")).'');
       $d=date('d',$toDayDate);
       $m=date('m',$toDayDate);
       $y=date('Y',$toDayDate);
...
.tablecss {
 ...
 $days=array();
   $summarydata='';
    $summarydata1=$table1."<br><table border='1px' class='tablecss'><tr  bgcolor='black' style='color:white'><th>Index</th> <th>Group</th><th>Asset</th><th>Mobile No</th><th>From Date</th><th>To Date</th><th>Total Distance</th></tr><tbody>"; 
     if(strpos($accountID,"gvk")>-1 || strpos($accountID,"gog")>-1){
  //       $summarydata1=$table1."<br><table border='1px'><tr><th>Index</th> <th>District</th><th>Base Location</th><th>Asset</th><th>Crew Number</th><th>From Date</th><th>To Date</th><th>Total Distance</th><th>Lat/Long</th><th>Operator</th><th>Status</th></tr><tbody>"; 
      $summarydata1=$table1."<br><table border='1px' class='tablecss'><tr  bgcolor='black' style='color:white'><th>Index</th> <th>District</th><th>Base Location</th><th>Asset</th><th>Crew Number</th><th>From Date</th><th>To Date</th>";
    }
       if($croneRequest=="yes"){
                  $summarydata1=$table1."<br><table border='1px'><tr><th>Index</th> <th>Group</th><th>Asset</th><th>Mobile No</th><th>Total Distance</th></tr><tbody>";
                  if(strpos($accountID,"gvk")>-1 || strpos($accountID,"gog")>-1){
                       $summarydata1=$table1."<br><table border='1px'><tr><th>Index</th> <th>District</th><th>Base Location</th><th>Asset</th><th>Crew Number</th><th>Total Distance</th><th>Lat/Long</th><th>Operator</th><th>Status</th></tr><tbody>";
   ...
   if($deviceID != "selectall"){
        if(strpos($accountID,"gvk1")>-1 || strpos($accountID,"gog1")>-1){
            $table= $table."<table border='1px' class='tablecss'><tr  bgcolor='black' style='color:white'><th>Index</th><th>Date</th><th>Start Time Of <br> The Day</th><th>End Time Of <br> The Day</th><th>Distance</th><th>Offline Time</th><th>Travel Route</th></tr><tbody>";
        }else{
                    $table= $table."<table border='1px' class='tablecss'><tr  bgcolor='black' style='color:white'><th>Index</th><th>Date</th><th>Idle Location For More<br> Than $idleTime mins</th><th>Total Idle Time</th><th>Start Time Of <br> The Day</th><th>End Time Of <br> The Day</th><th>Distance</th><th>Offline Time</th><th>Travel Route</th></tr><tbody>";
        }
    }else{
 
        if(strpos($accountID,"gvk1")>-1 || strpos($accountID,"gog1")>-1) {
                       $table= $table."</center><table border='1px' class='tablecss' ><tr  bgcolor='black' style='color:white'><th>Index</th><th>Date</th><th>Asset</th><th>Start Time Of <br> The Day</th><th>End Time Of <br> The Day</th><th>Distance</th><th>Offline Time</th><th>Travel Route</th></tr><tbody>";
        }else{       
          $table= $table."</center><table border='1px' class='tablecss'><tr  bgcolor='black' style='color:white'><th>Index</th><th>Date</th><th>Asset</th><th>Idle Location For More<br> Than $idleTime mins</th><th>Total Idle Time</th><th>Start Time Of <br> The Day</th><th>End Time Of <br> The Day</th><th>Distance</th><th>Offline Time</th><th>Travel Route</th></tr><tbody>";
        }
    }
   // $summaryIndx=0;
    ...
    for($devindx=0;$devindx<count($deviceArrya);$devindx++) {
       ...
       $sql = "Select accountID,deviceID,address,from_unixtime( timestamp, '%d-%m-%Y %H:%i:%s' ) as time1,statusCode,latitude,longitude,geozoneID,speedKPH from EventData where accountID='$accountID' and deviceID='".$deviceArrya[$devindx][4]."' and timestamp BETWEEN $fromDate AND $toDate and latitude<>0 and longitude<>0" ;
error_log($sql);
        ...
        while($row = mysqli_fetch_assoc($qry_result)) {
           ...
           if($indx==0){
                $data[$indx][9]=abs(strtotime($data[$indx][3])-$fromDate)/60;    
            }else{
...
$data[$indx][9]=abs(strtotime($data[$indx][3])-$toDate)/60;;
$data[$indx][3]=date('d-m-Y H:i:s',$toDate);
       $startDateforSummary='';
       $endDateforSummary='';
        $startTime='';
        $endTime='';
...
if($data[$indx][9]>$offlinetimerange){
                   ...
                   if($indx==0){
                     $offlinedetails=$offlinedetails."* From:".date('d-m-Y H:i:s',$fromDate)." To:".$data[$indx][3]." OfflineTime ".secondsToTimeFormate($data[$indx][9]*60)."<br>";
                    }else{
...
for($dindx=$fromDate;$dindx<$toDate;){
   ...
   //create pdf file  
     $newpdf=new PdfGeneretor();
        error_log("********************************************************************************************");
       $newpdf->pdfcreation($summarydata1.$sumdays."<th>Total Distance</th><th>Lat/Long</th><th>Operator</th><th>Status</th><th>Offline Time</th></tr><tbody>".$summarydata."<tr></tr><tr><td colspan='11'>*Off-road:Vehicle not Communicating from more than 12 hours *Not Responding:Never communicated </td></tr></tbody></table></body> </html>",$accountID.'_'.$group.'_'.$fromDate.'_distaneidlereportweekly',null,"Distance Idle Report","From :".date("d-m-Y",$fromDate)." To:".date("d-m-Y",$toDate));

$excel=new ExcelService();
$excel->generateExcel($summarydata1.$sumdays."<th>Total Distance</th><th>Lat/Long</th><th>Operator</th><th>Status</th><th>Offline Time</th></tr><tbody>".$summarydata."<tr></tr><tr><td colspan='11'>*Off-road:Vehicle not Communicating from more than 12 hours *Not Responding:Never communicated </td></tr></tbody></table>".$table."<tr><td colspan='6'></td></tr></tbody></table></body></html>",$accountID.'_'.$group.'_'.$fromDate.'_distaneidlereportweekly');

    if($reportType=="summary"){
         if($croneRequest!="yes"){
         $table=$summarydata1.$sumdays."<th>Total Distance</th><th>Lat/Long</th><th>Operator</th><th>Status</th><th>Offline Time</th></tr><tbody>".$summarydata."<tr></tr><tr><td colspan='11'>*Off-road:Vehicle not Communicating from more than 12 hours *Not Responding:Never communicated </td></tr></tbody></table>
    </body>
    </html>";
        }else{
       ...
       $table=$summarydata1.$sumdays."<th>Total Distance</th><th>Lat/Long</th><th>Operator</th><th>Status</th><th>Offline Time</th></tr><tbody>".$summarydata."<tr></tr><tr><td colspan='11'>*Off-road:Vehicle not Communicating from more than 12 hours *Not Responding:Never communicated </td></tr></tbody></table>".$table."<tr><td colspan='6'></td></tr></tbody></table>
    </body>
    </html>";
        }else{
