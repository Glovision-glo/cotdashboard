         ...
         // if($lastLocaton[$x][10] !="0"){
            ...
            $ydata[$j][1]="61717";
             $ydata[$j][2]="61717";
              ...
              $lastEvntTime=$lastLocaton[$x][1];//strtotime($row['time1']);
          ...
          if($ydata[$j][2]=="61714"){
              ...
              $ydata[$j][3]=floor($lastLocaton[$x][15]);// floor($row['speedKPH']);
       ...
       // if($row['statusCode']=="61714"){
        ...
        // } 
         ...
         $ydata[$j][21]="";
          ...
          $ydata[$j][4]=date('Y-m-d H:i:s',$lastLocaton[$x][1]);//$row['time1'];
          $ydata[$j][5]=0;//$lastLocaton[$x][1];//intval($row['odometerKM']);
...
mysqli_select_db($gtsconnect,$gtsdb);
     $query="select a.maintNotes,a.statusCodeState,a.lastValidHeading,a.lastValidSpeedKPH,a.lastValidLatitude,a.lastValidLongitude,a.deviceID as deviceID,a.lastGPSTimestamp as lastGPSTimestamp,a.description as description,a.vehicleModel as vehicleModel,c.contactPhone as simPhoneNumber,a.uniqueID as uniqueID,b.groupID as groupID,a.simPhoneNumber as simnum,a.lastStartTime,a.lastStopTime from Device a,DeviceList b,Driver c where a.accountID='$accountID' and b.groupID='$groupID' and b.accountID='$accountID' and c.accountID='$accountID' and a.deviceID=b.deviceID and c.deviceID=a.deviceID and c.deviceID=b.deviceID and c.accountID='$accountID' order by b.groupID,a.lastGPSTimestamp";
    if($userID == "admin" || $userID == "administrator" ||  $userID == "tracking"  || $userID == "monitoring"){
       // $query = "SELECT deviceID,lastGPSTimestamp,description,vehicleModel,simPhoneNumber,uniqueID FROM Device WHERE accountID ='$accountID'";
        $query="select DISTINCT a.deviceID as deviceID,a.maintNotes,a.statusCodeState,a.lastValidHeading,a.lastValidSpeedKPH,a.lastValidLatitude,a.lastValidLongitude,a.lastGPSTimestamp as lastGPSTimestamp,a.description as description,a.vehicleModel as vehicleModel,c.contactPhone as simPhoneNumber,a.uniqueID as uniqueID,b.groupID as groupID,a.simPhoneNumber as simnum,a.lastStartTime,a.lastStopTime from Device a,DeviceList b,Driver c where a.accountID='$accountID' and b.accountID='$accountID' and c.accountID='$accountID' and a.deviceID=b.deviceID and c.deviceID=a.deviceID and c.deviceID=b.deviceID and c.accountID='$accountID' order by b.groupID,a.lastGPSTimestamp";
...
mysqli_select_db($gtsconnect,$gtsdb);
    ...
    if($userID1 == "admin" || $userID1 == "administrator" || $userID == "tracking"  || $userID == "monitoring"){
       // $query = "SELECT deviceID,lastGPSTimestamp,description,vehicleModel,simPhoneNumber,uniqueID FROM Device WHERE accountID ='$accountID'";
