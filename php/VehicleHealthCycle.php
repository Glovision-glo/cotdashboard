       ...
       for($dateIndx=0;$dateIndx<$healthDays;$dateIndx++){
            ...
            if($group!="selectall"){
               ...
               if($UserQuery==""){
                ...
                $vehicleDetails="SELECT deviceID,count(*) as no FROM EventData  where accountID='$accountID' and deviceID in($UserQuery) and timestamp between $fromDump and $toDump GROUP BY deviceID ";
            }
