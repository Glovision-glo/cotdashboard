...
</script></head><body><div id='printarea'><center><h3>Summary Over Speed Report(More than $speedlimit Kmph)</h3>User ID:<b style='font-size:16px' >$userID </b>|District:<b style='font-size:16px' >$group</b> <br> From:".date('d-M-Y h:i:s',$fromDate )."  To:".date('d-M-Y h:i:s',$toDate )." <table border='1' class='tablecss'><thead style='background:black;color:white'><th>S.NO</th><th>Vehicle ID</th><th>District</th><th>Base Location</th><th>No Of Times Crossed</th></thead><tbody>";
