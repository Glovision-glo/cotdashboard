...
<html>
   <head>
           ...
           function initialise4() {
              ...
              var lineSymbol = {
               ...
               for(var m=0;m<event.length-1;m++){
                    ...
                    vehicleTrack(evntdata[2],evntdata[3],lineSymbol,map,evntdata[6],"no",evntdata[7],evntdata[1]+"<br> Address:"+evntdata[10]);
              ...
              var info="Case ID:<b>"+caseID+"</b><br>VehicleID :<b>"+vehicleID+"</b><br>Beneficiary Name :<b>"+infocase[3]+"</b><br> Contact:<b>"+infocase[4]+"</b><br>Travell Distance:<b>"+parseInt(cumulativeDistance)+"</b> Kms";

              document.getElementById("caseinfor").innerHTML = "Case Information : <br>"+info;
              pushpin(map,parseFloat(startEvent[2]),parseFloat(startEvent[3]),"Start","yes",100);
            if(infocase[5]!="" && infocase[5]!="0")
              ...
              pushpin(map,endEvent[2],endEvent[3],"Vehicle:"+vehicleID,'yes',1000,"../images/vehicle.png");
    ...
    <style>
         ...
         #logout {border-radius: 10px; position: absolute; background-color: transparent;height:200px; width:220px;top:0px; left:0px; z-index: 99; background: #E6E6E6;} 
         #help{ 
